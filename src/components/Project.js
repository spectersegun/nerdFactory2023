        ...
        <div class="carousel-wrap ">
          <div class="filter_box">
            ...
            <nav class="owl-filter-bar">
              <a href="#" class="item active" data-owl-filter="*">
                All
              </a>
              <a href="#" class="item" data-owl-filter=".painting">
                Painting
              </a>
              <a href="#" class="item" data-owl-filter=".reconstruction">
                Reconstruction{" "}
              </a>
              <a href="#" class="item" data-owl-filter=".repair">
                Repairs{" "}
              </a>
              <a href="#" class="item" data-owl-filter=".residential">
                Residential{" "}
              </a>
              <a href="#" class="item" data-owl-filter=".styling">
                Styling{" "}
              </a>
            </nav>
          </div>
